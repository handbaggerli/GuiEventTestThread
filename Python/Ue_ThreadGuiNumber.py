...
from WorkerNumber import WorkerNumber


class Ue_ThreadGuiNumber(Ui_ThreadGui):
    ...
    def connect_user_events(self):
        ...
        self.worker = WorkerNumber(event_comm=self.event_comm, identification=self.identification)
        self.worker.start()
